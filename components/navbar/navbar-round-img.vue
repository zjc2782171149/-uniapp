<template>
  <view class="slot">
    <u-navbar
      ...
      :border-bottom="false"
      :is-back="isBack"
      :title-color="titleColor || appThemeTextWhiteColor"
      :back-icon-size="32"
      :back-icon-color="backIconColor || appThemeTextWhiteColor"
      :background="{ backgroundColor: backgroundColor || appThemeColor }"
      :title="title"
    ></u-navbar>
...
export default {
  ...
  props: {
    ...
    bgImg: {
      type: String,
      default: "https://cxj.zhangjiancong.top/images/cxj/bg/bg.png",
    },
    // 是否带返回按钮
    isBack: {
      type: Boolean,
