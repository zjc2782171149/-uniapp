<template>
  <view class="page">
    ...
    >
      <image
        class="logo"
        src="https://cxj.zhangjiancong.top/images/cxj/logo/logo.png"
      ></image>
    ...
    <view class="loginSmsCode" v-if="pageStatus == 'loginByCode'">
      ...
      <view style="padding-top: 64rpx">
        <u-button
          :disabled="!loginCodeForm.phone || !loginCodeForm.smsCode"
          type="gold"
          shape="circle"
          @click="getWxLoginRole(0)"
          >登录</u-button
        >
      </view>
    </view>
    ...
    >
      <view class="agree_img" @click="changeAgreeFlag" v-show="!agree_flag">
        <image
          src="https://cxj.zhangjiancong.top/images/cxj/operate/check.png"
        ></image>
      </view>
      <view class="agree_img" @click="changeAgreeFlag" v-show="agree_flag">
        <image
          src="https://cxj.zhangjiancong.top/images/cxj/operate/checked.png"
        ></image>
      </view>
...
import { checkTelephone } from "@/utils/phone.js";
