<template>
  <view class="slot" :class="data.bgImgType">
    <view class="inner">
      <view class="left">
      ...
      <view class="right">
        <view
          class="point"
          v-if="data.bgImgType == 'yellow'"
          :style="{ color: yellowColor }"
          >{{ data.points }}积分</view
        >
        <view
          class="point"
          v-if="data.bgImgType == 'blue'"
          :style="{ color: blueColor }"
          >{{ data.points }}积分</view
        >
        <view
          @click="exchangeDiscount"
          class="operate"
          v-if="data.bgImgType == 'yellow'"
...
.slot {
  ...
  margin-bottom: 24rpx;
  &.yellow {
    background-image: url("https://cxj.zhangjiancong.top/images/cxj/mine/discounts-yellow.png");
    background-size: cover;
  }
  &.blue {
    background-image: url("https://cxj.zhangjiancong.top/images/cxj/mine/discounts-blue.png");
    background-size: cover;
  }
  .inner {
    display: flex;
