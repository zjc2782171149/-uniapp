	...
	<view class="page">
		...
		<view class="cart-list">
			<view class="item" v-for="(goods, index) in goodsList" :key="index">
				<view class="left"><u-checkbox shape="circle" active-color="red" icon-size="16" v-model="goods.checked"></u-checkbox></view>
				<view class="right">
					<view class="img"><image :src="goods.pics" mode=""></image></view>
					<view class="info">
		...
		<view class="btn">
			<view class="inner">
				<view class="check">
					<u-checkbox shape="circle" active-color="red" icon-size="16" v-model="checkAllStauts" @change="checkAllGoods"></u-checkbox>
					<text>全选</text>
				</view>
				<view class="right">
					<view class="price">
					...
					<u-button type="error" @click="goPayResult">去结算({{ goodsList.filter(item => item.checked).length }})</u-button>
				</view>
			</view>
		</view>
	</view>
...
export default {
	...
	onShow() {
		...
		this.goodsList = getApp().globalData.goodsList;
