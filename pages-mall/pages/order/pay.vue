			...
			<u-grid :col="1" :border="false">
				<u-grid-item>
					<u-image width="300rpx" height="300rpx"
						src="https://www.zhangjiancong.top/public/cxj/pay/wxpay.jpg"></u-image>
					<view class="grid-text">微信支付</view>
				</u-grid-item>
				<u-grid-item>
					<u-image width="300rpx" height="300rpx"
						src="https://www.zhangjiancong.top/public/cxj/pay/alipay.jpg"></u-image>
