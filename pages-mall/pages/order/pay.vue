		...
		<view class="pay-type">
			...
			<u-radio-group v-model="payType" :wrap="true">
				<view class="item" @click="payType = '微信'">
					...
					<view class="check">
						<u-radio shape="circle" :active-color="appThemeColor" icon-size="16" name="微信"></u-radio>
					</view>
				</view>
				...
				<view class="item" @click="payType = '支付宝'">
					...
					<view class="check">
						<u-radio shape="circle" :active-color="appThemeColor" icon-size="16" name="支付宝"></u-radio>
					</view>
				</view>
			</u-radio-group>
		</view>
