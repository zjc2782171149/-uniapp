  ...
  <view class="slot" @click.stop="goOrderInfo">
    ...
    <view class="operate" v-if="data.status == 0">
      <u-button
        ...
        size="small"
        shape="circle"
        @click="cancelOrderNow()"
        >取消订单</u-button
      >
      <u-button type="gold" size="small" shape="circle" @click="goPay()"
        >去付款</u-button
      >
    </view>
    <!-- 待发货 -->
    <view class="operate" v-if="data.status == 1">
      <u-button
        ...
        size="small"
        shape="circle"
        @click="showRemindAgain('提醒')"
        v-if="data.isRemind === 1"
        >提醒发货</u-button
      >
      <u-button
        type="gold"
        size="small"
        shape="circle"
        @click="pushDeliveryNow()"
        v-if="data.isRemind === 0"
        >提醒发货</u-button
      >
    </view>
    <!-- 待收货 -->
    ...
    <view class="operate" v-if="data.status == 3">
      ...
      <u-button
        ...
        size="small"
        shape="circle"
        @click="showRemindAgain('评价')"
        v-if="data.isEvaluate === 1"
        >去评价</u-button
      >
      <u-button
        type="gold"
    ...
    <view class="operate" v-if="data.status == 4">
      <u-button
        ...
        >删除记录</u-button
      >
      <u-button type="gold" size="small" shape="circle" @click="goOrderInfo()"
        >查看详情</u-button
      >
    </view>
    <!-- 已完成 -->
