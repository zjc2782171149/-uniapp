<template>
	<view class="slot">
		...
		<view class="right">
			<u-button style="width: 210rpx; border-radius: 40rpx 0 0 40rpx;" size="medium" :ripple="true" type="warning" @click="addShoppingCart" >加入购物车</u-button>
			<u-button style="width: 210rpx; border-radius: 0 40rpx 40rpx 0;" size="medium" :ripple="true" type="error" @click="buyNow" >立即购买</u-button>
		</view>
	</view>
</template>
