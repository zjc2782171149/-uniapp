  ...
  <view class="page">
    ...
    <view>
      <u-navbar
        :custom-back="toMine"
        title="个人中心"
        :background="{ backgroundColor: 'rgb(221, 195, 135)' }"
      >
      </u-navbar>
    </view>
    <!-- 表单 -->
    ...
    <view class="btn">
      <div class="btn_item">
        <u-button type="gold" shape="circle" @click="submit"
          ><text>保存</text></u-button
        >
      </div>
      <div class="btn_item">
        <u-button type="default" shape="circle" @click="logout"
          ><text>退出登录</text></u-button
        >
      </div>
    </view>
    ...
    >
      <view class="slot-content">
        <u-field
          ...
          clearable
          :border-bottom="false"
          v-model="personal_signatureTemp"
          label="个性签名"
          required
          auto-height
          type="textarea"
