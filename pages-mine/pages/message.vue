        ...
        <view class="" v-for="(msgCommunity, i) in communityList" :key="i">
          <view class="card" v-if="currentTab == 0">
            ...
            <view class="inner community">
              <u-avatar
                size="100"
                src="https://cxj.zhangjiancong.top/images/cxj/virtual.png"
              ></u-avatar>
              <view class="right">
                <view class="info">
        ...
        <view class="" v-for="(msgSystem, j) in systemList" :key="j">
          <view class="card" v-if="currentTab == 1">
            ...
            <view class="inner system">
              ...
              <view class="content">
                <text
                  >盛夏来袭全民动起来系统消息系统消息盛夏来袭全民动起来系统消息系统消息盛夏来袭全民动起来系统消</text
                >
                <text>点击查看>></text>
              </view>
            </view>
  ...
  data() {
    return {
      ...
      tabOps: [
        {
          label: "社区消息",
          icon: "https://cxj.zhangjiancong.top/images/cxj/mine/message-community.png",
          iconActive:
            "https://cxj.zhangjiancong.top/images/cxj/mine/message-community-active.png",
        },
        {
          label: "系统消息",
          icon: "https://cxj.zhangjiancong.top/images/cxj/mine/message-system.png",
          iconActive:
            "https://cxj.zhangjiancong.top/images/cxj/mine/message-system-active.png",
        },
      ],
      // 假数据
      communityList: [
